...
Potree.Viewer = class PotreeViewer extends THREE.EventDispatcher{
	...
	constructor(domElement, args = {}){
		...
		this.classifications = {
			0: { visible: true, name: 'Área externa' },
			1: { visible: true, name: 'Cobertura 2o. Andar' },
			2: { visible: true, name: 'Cobertura 1o. andar' },
			3: { visible: true, name: 'Segundo andar' },
			4: { visible: true, name: 'Primeiro Andar' },
			5: { visible: true, name: 'Térreo' },
			6: { visible: true, name: 'Cobertura térreo' },
...
initSidebar = (viewer) => {
	...
	function initClassificationList () {
		...
		addClassificationItem(0, 'Área externa' );
		addClassificationItem(1, 'Cobertura 2o. Andar' );
		addClassificationItem(2, 'Cobertura 1o. andar' );
		addClassificationItem(3, 'Segundo andar' );
		addClassificationItem(4, 'Primeiro Andar' );
		addClassificationItem(5, 'Térreo' );
		addClassificationItem(6, 'Cobertura térreo' );
		addClassificationItem(7, 'não classificado');
		addClassificationItem(8, 'não classificado');
		addClassificationItem(9, 'não classificado');
		addClassificationItem(12,'não classificado');
	}
