...
Potree.Viewer = class PotreeViewer extends THREE.EventDispatcher{
	...
	constructor(domElement, args = {}){
		...
		this.classifications = {
			0: { visible: true, name: 'Eng. de Produção-Biênio' },
			1: { visible: true, name: 'Eng. Civil' },
			2: { visible: true, name: 'Administração' },
			3: { visible: true, name: 'Eng. Elétrica' },
			4: { visible: true, name: 'Eng. Metalúrgica e de materiais' },
			5: { visible: true, name: 'Eng. de minas e petróleo' },
			6: { visible: true, name: 'Eng. Mecânica' },
			7: { visible: true, name: 'TNP' },
			8: { visible: true, name: 'CITI' },
			9: { visible: true, name: 'Praça R. de Azevedo' },
			10: { visible: true, name: 'Unclassified' }
		};
...
initSidebar = (viewer) => {
	...
	function initClassificationList () {
		...
		addClassificationItem(0, 'Eng. de Produção-Biênio');
		addClassificationItem(1, 'Eng. Civil');
		addClassificationItem(2, 'Administração');
		addClassificationItem(3, 'Eng. Elétrica');
		addClassificationItem(4, 'Eng. Metalúrgica e de materiais');
		addClassificationItem(5, 'Eng. de minas e petróleo');
		addClassificationItem(6, 'Eng. Mecânica');
		addClassificationItem(7, 'TNP');
		addClassificationItem(8, 'CITI');
		addClassificationItem(9, 'Praça R. de Azevedo');
		addClassificationItem(12, 'Unclassified');
	}
